<template>
  <div class="bg-surface border border-surface-border rounded-xl hover:border-gold/30 transition-colors group">

    <!-- Mobile layout -->
    <div class="sm:hidden flex items-start gap-3 p-3">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-start gap-2 mb-2.5">
          <div class="flex-1 min-w-0">
            <p class="text-sm font-medium text-gray-100 truncate leading-snug">{{ link.title }}</p>
            <p class="text-xs text-gray-500 truncate mt-0.5">{{ link.url }}</p>
          </div>
          <button
            class="shrink-0 w-10 h-6 rounded-full transition-colors duration-200 relative mt-0.5"
        ...
        <!-- Bottom row: click count + actions -->
        <div class="flex items-center justify-between">
          <div>
            <span class="text-sm font-semibold text-gold">{{ link.click_count }}</span>
            <span class="text-xs text-gray-600 ml-1">clicks</span>
          </div>
          <div class="flex items-center gap-1">
            <button
              class="p-2 text-gray-500 hover:text-gray-100 hover:bg-surface-raised rounded-lg transition-colors"
